...
export const ButtonDropMenu = ({
  ...
  return createPortal(
    <AnimatePresence>
      {isVisible && (
        <div onClick={removeMenu} className="absolute inset-0 grid place-content-center">
          <motion.div
            ...
            className="min-w-40 p-1 absolute rounded-md bg-white shadow-lg z-20 translate-x-0 overflow-hidden"
          >
            {children}
          </motion.div>
        </div>
